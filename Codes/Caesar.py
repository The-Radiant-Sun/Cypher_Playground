...
class CaesarCypher:
    ...
    def history():
        ...
        history = '''Use a numeric key, it is recommended to be within range ONE - TWENTY-SIX,
though if numbers far outside this range is inputted, then the program will lag.
...
and it can be easily broken even by hand. '''
        return history
